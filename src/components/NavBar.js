...
const NavBar = () => {
    ...
    return (
        <header
            ...
            dark:text-light relative z-10 lg:px-10 md:px12 sm:px8'
        >
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    <motion.a href="https://twitter.com/jocsanrch" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mr-3"
                    >
                    ...
                    <motion.a href="https://github.com/jocscriptch/jocscriptch" target={"_blank"}
                        className="w-6 mx-3"
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                    >
                    ...
                    <motion.a href="https://www.linkedin.com/in/jocsan-ramirez-chaves/" target={"_blank"}
                        className="w-6 ml-3"
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                    >
...

            {
                isOpen ?
                    ...
                    className="min-w-[70vm] flex flex-col justify-between z-30 items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                        ...
                        <nav className="flex items-center flex-col justify-center">
                            ...
                            <CustomMobileLink href="/contact" title="Contact" className='' toogle={handleClick} />
                        </nav>
