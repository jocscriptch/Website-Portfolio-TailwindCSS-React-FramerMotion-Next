...
const Skills = () => {
    return (
        <>
            <h2 className='font-bold text-5xl mt-55 w-full text-center md:text-6xl md:mt-32 py-8'>Skills</h2>
            ...
            sm:bg-circularLightSm sm:dark:bg-circularDarkSm'>
                ...
                <Skill name="HTML5" x="-30vw" y="5vw"/>
                <Skill name="CSS3" x="-10vw" y="-14vw"/>
                ...
                <Skill name="Tailwind" x="-10vm" y="22vw"/>
                <Skill name="Figma" x="-20vm" y="-22vw"/>
                <Skill name="Java" x="-22vw" y="-5vw"/>
